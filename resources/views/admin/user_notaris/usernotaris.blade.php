        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('user_notaris.create')}}" class="btn btn-primary btn-sm">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="display: flex; justify-content: left;">
                                            <a style="margin-right: 10px" href="{{ route('user_notaris.edit', $value->uid) }}" class="btn btn-warning mb-1 mr-1 " data-toggle="tooltip" title='Update'><i class="fa-solid fa-pen"></i></a>
                                            <form action="{{ route('user_notaris.destroy', $value->uid) }}" method="post">
                                                @method('DELETE')
                                                @csrf
