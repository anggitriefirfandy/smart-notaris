...
$(document).ready(function () {
    ...
    if ($("#fees-chart").length > 0) {
        ...
        var chart = new ApexCharts(document.querySelector("#fees-chart"), sCol);
    ...
    if ($("#exam-result-chart").length > 0) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#exam-result-chart"),
            options
        );
        chart.render();
    }
    ...
    if ($("#statistic_chart").length > 0) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#statistic_chart"),
            options
        );
        chart.render();
    }
...
if ($("#total-chart").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#active-chart"),
        options
    );
    chart.render();
}
...
if ($("#inactive-chart").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#inactive-chart"),
        options
    );
    chart.render();
}
...
if ($("#invoice-report").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#invoice-report"),
        options
    );
    chart.render();
}
...
if ($("#employee-reports").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#employee-reports"),
        options
    );
    chart.render();
}
...
if ($("#attendance-report").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#attendance-report"),
        options
    );
    chart.render();
}
...
if ($("#leave-report").length > 0) {
    var options = {
        ...
        xaxis: {
            categories: [
                ...
                "Nov",
                "Dec",
            ], // Update to match your time frame
        },
        yaxis: {
            labels: {
                offsetX: -15,
    ...
    var chart = new ApexCharts(
        document.querySelector("#leave-report"),
        options
    );
    chart.render();
}
...
if ($("#daily-report").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#daily-report"),
        options
    );
    chart.render();
}
...
if ($("#revenue-chart").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#revenue-chart"), sCol);
...
if ($("#emp-department").length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector("#emp-department"), sBar);
...
if ($("#performance_chart2").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#performance_chart2"),
        options
    );
    chart.render();
}
...
if ($("#deals_stage").length > 0) {
    var sColStacked = {
        ...
        series: [
            {
                name: "Jumlah Pegawai",
                data: [80, 40, 100, 20, 60, 100, 80, 80],
            },
        ],
        xaxis: {
            categories: ["SD", "SMP", "SMA/K", "D3", "D4", "S1", "S2", "S3"],
            labels: {
                style: {
                    colors: "#6B7280",
                    fontSize: "13px",
...
if ($("#top_deal_chart").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#top_deal_chart"),
        options
    );
    chart.render();
}
...
if ($("#pipeline_chart").length > 0) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#pipeline_chart"),
        options
    );
    chart.render();
}
...
if ($("#donut-chart-2").length > 0) {
    var options = {
        ...
        labels: ["Demosi", "Promosi", "Rotasi", "Mutasi"], // Labels for the data
